...
import styles from "../styles/Create.module.css"; // CSS Module for this page
  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <div className={styles.formContainer}>
        ...
        {preview && (
          <img src={preview} alt="Preview" className={styles.postImage} />
        )}

        <button onClick={handleSubmit} className={styles.readMore}>
          Create Post
        </button>
